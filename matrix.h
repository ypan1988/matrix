...
struct _Matrix_base {
	...
	_Matrix_base(const value_type& __x, uword __n) : _M_elem(__x, __n), _M_size(__n) {}
	_Matrix_base(const value_type* __x, uword __n) : _M_elem(__x, __n), _M_size(__n) {}
	_Matrix_base(const std::valarray<_Tp>& __x, uword __n) : _M_elem(__x), _M_size(__n) {}
	_Matrix_base(const std::slice_array<_Tp>& __x, uword __n) : _M_elem(__x), _M_size(__n) {}
	_Matrix_base(const std::gslice_array<_Tp>& __x, uword __n) : _M_elem(__x), _M_size(__n) {}
	_Matrix_base(const std::mask_array<_Tp>& __x, uword __n) : _M_elem(__x), _M_size(__n) {}
	_Matrix_base(const std::indirect_array<_Tp>& __x, uword __n) : _M_elem(__x), _M_size(__n) {}
	~_Matrix_base() {}
...
public:
	...
	Matrix(uword __n1)
		: _Matrix_base<_Tp>(__n1), _M_d1(__n1)
	{
	}
...
public:
	...
	Matrix(uword __n1, uword __n2, uword __n3)
		: _Matrix_base<_Tp>(__n1*__n2*__n3), _M_d1(__n1), _M_d2(__n2), _M_d3(__n3),
		_M_d1xd2(__n1*__n2)
	{
	}
	Matrix(const value_type& __x, uword __n1, uword __n2, uword __n3)
		: _Matrix_base<_Tp>(__x, __n1*__n2*__n3), _M_d1(__n1), _M_d2(__n2), _M_d3(__n3),
		_M_d1xd2(__n1*__n2)
	{
	}
	Matrix(const value_type* __x, uword __n1, uword __n2, uword __n3)
